...
<p>
				氏名<input type="text" name="name" placeholder="氏名を入力してください"value="${student.getName()}"
					required />
</p>
<p>クラス<select
				class="form-select" id="student-f2-select" name="classNum" >
...
<input type="submit" value="変更" style="max-width: 130px;  background-color: #5577ff; color: white; text-align: center;">
