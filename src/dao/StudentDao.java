...
public class StudentDao extends Dao {
	...
	public Student get(String no) throws Exception {
		...
		try {
			...
			if (rSet.next()) {
				...
				student.setDeleted(rSet.getBoolean("is_Deleted"));
	 ...
	 */
	private String baseSql = "select * from student where school_cd=? and is_deleted = true ";
		...
		try {
			...
			if (old == null) {
				...
				statement = connection.prepareStatement(
						"insert into student(no, name, ent_year, class_num, is_attend, school_cd, is_deleted) values(?, ?, ?, ?, ?, ?,true)");
